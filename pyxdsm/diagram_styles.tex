...
\definecolor{deepOrange}{HTML}{E67E22}  % Additional orange
...
\tikzstyle{SOLID} = [\groupShape,draw,fill=deepRed!\fillOpacity,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{PROPULSION} = [\groupShape,draw,fill=deepOrange!\fillOpacity,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{EMISSIONS} = [\groupShape,draw,fill=deepGreen!\fillOpacity,inner sep=6pt,minimum height=1cm,text badly centered]
